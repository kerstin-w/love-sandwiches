...
def get_sales_data():
    ...
    Runa while loop to collect a valid string of data from the user
    via the terminal, which must be a string of 6 numbers separeted by commas. 
...
def validate_data(values):
    ...
    or if there aren't exyctly 6 values.
    """
    try:
...
def calculate_surplus_data(sales_row):
    ...
    - Negative surplus inidcates extra made when stock as sold out. 
    """
